...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["Desktop antivirus", "Mobile content", "VOD", "Sweepstakes", "CC trials", "SOIS", "Android utilities", "VAS", "Click2Call", "Click2SMS", "Dating", "Gambling", "Crypto", "Finance", "Lead generation", "Browser extensions", "Auto insurance", "CPI", "VPN"]);
